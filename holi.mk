...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/media/media_blair/video_system_specs.json:$(TARGET_COPY_OUT_VENDOR)/etc/video_system_specs.json \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/public.libraries-qti.system-ext.txt:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/public.libraries-qti.txt
